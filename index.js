...
app.delete(apiPath + version + '/events/:eventId/bookings/:bookingId', (req, res) => {
    ...
    var admin_info = {login: 'admin', password: 'c2VjcmV0'};
    var login = req.headers.name;
    var pw = Buffer.from(req.headers.password, 'binary').toString('base64');

    if(admin_info.login != login || pw != admin_info.password){
